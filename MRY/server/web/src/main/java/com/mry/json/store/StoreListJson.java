...
//    }
    ...
    public StoreListJson(StoreManagement data) {
        this.auditStatus = data.getAuditStatus();
        this.causeOfFailure = data.getCauseOfFailure();
        this.storeStatus = data.getStoreStatus();
        this.managementCycle = data.getManagementCycle();
        this.id = data.getId();
     ...
     //   this.telNumber = data.gette;
        this.storeType = data.getStoreType();
        this.operationMode = data.getOperationMode();
        this.shopSquare = data.getShopSquare();
        this.annualRent = data.getAnnualRent();
        this.severalStores = data.getSeveralStores();
        this.numberOfRooms = data.getNumberOfRooms();
        this.numberOfBeds = data.getNumberOfBeds();
        this.numberOfEmployees = data.getNumberOfEmployees();
        this.areThereAnySales = data.getAreThereAnySales();
        this.areThereAnyShop = data.getAreThereAnyShop();
        this.cashFlow = data.getCashFlow();
        this.practiceInTheShop = data.getPracticeInTheShop();
        this.innPassengerFlow = data.getInnPassengerFlow();
        this.productPerformance = data.getProductPerformance();
        this.directProductBrand = data.getDirectProductBrand();
        this.brandNumber = data.getBrandNumber();
        this.typeOfInstrument = data.getTypeOfInstrument();
        this.numberOfInstruments = data.getNumberOfInstruments();
        this.instrumentBrand = data.getInstrumentBrand();
        this.salarySystem = data.getSalarySystem();
        this.employeeSalary = data.getEmployeeSalary();
        this.projectPriceList = data.getProjectPriceList();
        this.card = data.getCard();
        this.extensionCard = data.getExtensionCard();
        this.oneCard1 = data.getOneCard1();
        this.oneCard2 = data.getOneCard2();
        this.oneCard3 = data.getOneCard3();
        this.extensionMethod = data.getExtensionMethod();
        this.newCustomers = data.getNewCustomers();
        this.numberOfTransactions = data.getNumberOfTransactions();
        this.numberOfTransactions1 = data.getNumberOfTransactions1();
        this.numberOfTransactions2 = data.getNumberOfTransactions2();
        this.numberOfCustomers = data.getNumberOfCustomers();
        this.theNumberOfRenewals = data.getTheNumberOfRenewals();
        this.theBiggestProblem = data.getTheBiggestProblem();
    }
}
