...
/**
 * Created by kaik on 2017/12/26.
 */
public class StoreCustomerJson {
...
//    private Boolean classC;
    ...
    public StoreCustomerJson(StoreManagement data) {
        this.managementCycle = data.getManagementCycle();
        this.establishContactN = data.getEstablishContactN();
        this.customerClassification = data.getCustomerClassification();
        this.regularCustomers = data.getRegularCustomers();
        this.regularCustomersN = data.getRegularCustomersN();
        this.frozenCustomers = data.getFrozenCustomers();
        this.frozenCustomersN = data.getFrozenCustomersN();
        this.customerAnalysis = data.getCustomerAnalysis();
        this.id = data.getId();
        this.exclusivePointList = data.getExclusivePointList();
        this.continuousService = data.getContinuousService();
        this.serviceTimes = data.getServiceTimes();
        this.customerIntroduction = data.getCustomerIntroduction();
        this.technician = data.getTechnician();
        this.customerComplaint = data.getCustomerComplaint();
        this.establishContact = data.getEstablishContact();
        this.noStore = data.getNoStore();
        this.noStoreN = data.getNoStoreN();
        this.cashPoor = data.getCashPoor();
        this.cashPoorN = data.getCashPoorN();
        this.classA = data.getClassA();
//        this.classB = data.getClassB();
//        this.classC = data.getClassC();
        this.bigCustomer = data.getBigCustomer();
        this.bigCustomerN = data.getBigCustomerN();
        this.ordinaryCustomer = data.getOrdinaryCustomer();
        this.ordinaryCustomerN = data.getOrdinaryCustomerN();
        this.sleepCustomer = data.getSleepCustomer();
        this.sleepCustomerN = data.getSleepCustomerN();
        this.bloodType = data.getBloodType();
        this.constellation = data.getConstellation();
        this.incomeMode = data.getIncomeMode();
        this.annualIncome = data.getAnnualIncome();
        this.objective = data.getObjective();
        this.face = data.getFace();
        this.body = data.getBody();
        this.internalCause = data.getInternalCause();
        this.externalcause = data.getExternalcause();
        this.advisorDesignation = data.getAdvisorDesignation();
    }
}
