...
public class MembersEnjoyListJson {
    ...
    public MembersEnjoyListJson(MembersEnjoy a) {
        this.id = a.getId();
        this.enjoyValidity = a.getEnjoyValidity();
        this.enjoyNumber = a.getEnjoyNumber();
        if(a.getProject() != null) {
            this.projectName = a.getProject().getProjectName();
            this.projectId = a.getProject().getId();
        }
        this.agingType = a.getAgingType();
    }
}
