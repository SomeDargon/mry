 ...
 */
public class AlipayWebsiteNotify {
	private static final Logger logger = LoggerFactory.getLogger(AlipayWebsiteNotify.class);
	...
	public static boolean verify(Map<String, String> params, String partner,
		...
		boolean isSign = getSignVeryfy(params, sign, securityKey);
	...
	private static boolean getSignVeryfy(Map<String, String> Params,
			String sign, String securityKey) {
		...
		if (AlipayConfig.sign_type.equals("MD5")) {
			isSign = MD5.verify(preSignStr, sign, securityKey,
