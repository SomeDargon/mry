...
public class TreatmentJsonListJson {
    ...
    public TreatmentJsonListJson(TreatmentCardManagement data) {
        this.id = data.getId();
        this.storeName = data.getStoreName();
        this.storeId = data.getStoreId();
        this.treatmentName = data.getTreatmentName();
        this.treatmentNumber = data.getTreatmentNumber();
        ...
        this.treatmentCardValidity = data.getTreatmentCardValidity();
        this.isDisplay = data.getDisplay();
