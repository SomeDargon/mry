 ...
 */
public class MembershipListJson {
    ...
    private List<MembersEnjoyListJson> enjoy;
    ...
    public List<MembersEnjoyListJson> getEnjoy() {
        return enjoy;
    }

    public void setEnjoy(List<MembersEnjoyListJson> enjoy) {
        this.enjoy = enjoy;
    }
    ...
    public MembershipListJson(MembershipCardManagement data) {
        this.id = data.getId();
        this.storeName = data.getStoreName();
        this.storeId = data.getStoreId();
        this.membershipName = data.getMembershipName();
        this.settingTime = data.getSettingTime();
        if(data.getMembershipMoney() != null) {
            this.membershipMoney = data.getMembershipMoney().toString();
        }
        this.liftCardType = data.getLiftCardType();

        this.projectDiscount = String.valueOf(data.getProjectDiscount());
        this.productDiscount = data.getProductDiscount();
        this.membershipValidity = data.getMembershipValidity();
        if(data.getEnjoy() != null) {
           this.memberDay = data.getMemberDay();
        }
        this.memberDayNtoStore = data.getMemberDayNtoStore();
        this.memberDayNProject = data.getMemberDayNProject();
        this.memberDayDiscount = data.getMemberDayDiscount();
        this.memberReturnNtoStore = data.getMemberReturnNtoStore();
        this.memberReturnNProject = data.getMemberReturnNProject();
        if(data.getReturnAmount() != null) {
            this.returnAmount = data.getReturnAmount().toString();
        }
        this.returnValidity = data.getReturnValidity();
        this.precautions = data.getPrecautions();
        if(data.getEnjoy()!= null){
            this.enjoy = new ArrayList<>();
            data.getEnjoy().forEach(a ->this.enjoy.add(new MembersEnjoyListJson(a)));
        }
