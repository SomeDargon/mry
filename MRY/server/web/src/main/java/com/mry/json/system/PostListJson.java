...
public class PostListJson {
    ...
    public PostListJson(PostManagement data) {
        this.id = data.getId();
        this.employeeRank = data.getEmployeeRank();
        this.employeeType = data.getEmployeeType();
        this.storeName = data.getStoreName();
        this.storeId = data.getStoreId();
        this.postName = data.getPostName();
        this.postDuties = data.getPostDuties();
        this.workflow = data.getWorkflow();
        this.achievements = data.getAchievements();
        this.technicalExamination = data.getTechnicalExamination();
        this.checkWorkAttendance = data.getCheckWorkAttendance();
        if(data.getMultiMonthCash() != null){
            this.multiMonthCash = data.getMultiMonthCash().toString();
        }
        this.dataRankings = data.getDataRankings();
        if(data.getShareAmount() != null){
            this.shareAmount = data.getShareAmount().toString();
        }
        this.dividendManagement = data.getDividendManagement();
        this.natureOfEquity = data.getNatureOfEquity();
    }
}
