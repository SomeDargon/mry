...
import com.mry.alipay.sign.MD5;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara,
		...
		if (AlipayConfig.sign_type.equals("MD5")) {
			mysign = MD5.sign(prestr, securityKey, AlipayConfig.input_charset);
		}
		return mysign;
	}
	...
	private static Map<String, String> buildRequestPara(
			Map<String, String> sParaTemp, String securityKey) {
		// 除去数组中的空值和签名参数
		Map<String, String> sPara = AlipayCore.paraFilter(sParaTemp);
		// 生成签名结果
		String mysign = buildRequestMysign(sPara, securityKey);
	...
	public static String buildRequest(Map<String, String> sParaTemp,
			String strMethod, String strButtonName, String securityKey) {
		// 待请求参数数组
		Map<String, String> sPara = buildRequestPara(sParaTemp, securityKey);
	...
	public static String query_timestamp(String partner)
		...
		String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner="
				+ partner + "&_input_charset" + AlipayConfig.input_charset;
