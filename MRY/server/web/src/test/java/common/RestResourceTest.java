...
//		authToken = "a4c1054d-30e5-4a8e-acd3-4ce9a4cf0fc1-c";
//		authToken = "949549fe-2725-4c48-85a3-9099870b6dc5-c";

		// assistant token
		// authToken = "457b2225-ae38-4eb6-8a7b-dea5fd9dca6e-d";

		// admin token
		// authToken = "a9d2c04a-905e-485b-b480-66e6f36dbb53";
		...
		// for (int i = 0; i < 100; i++) {
		// get("/app/api/common/cometd/test?p="+System.nanoTime() + "&id=" +
		// (i+1));
		// }
	...
	private static void testXXX(){
		String path = "/app/api/account/detail";
