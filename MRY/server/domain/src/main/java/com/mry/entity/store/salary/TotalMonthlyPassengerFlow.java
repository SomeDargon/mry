 ...
 * 月客流总量
 */
@ApiModel(value="月客流总量",description="月客流总量")
@Entity
@Table(name = TotalMonthlyPassengerFlow.TABLE_NAME)
public class TotalMonthlyPassengerFlow  extends BaseEntity {

    public static final String TABLE_NAME = "total_monthly_passenger_flow";
