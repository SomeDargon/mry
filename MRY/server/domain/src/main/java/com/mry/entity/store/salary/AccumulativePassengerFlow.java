 ...
 * 累计客流
 */
@ApiModel(value="累计客流",description="累计客流")
@Entity
@Table(name = AccumulativePassengerFlow.TABLE_NAME)
public class AccumulativePassengerFlow extends BaseEntity {

    public static final String TABLE_NAME = "accumulative_passenger_flow";
