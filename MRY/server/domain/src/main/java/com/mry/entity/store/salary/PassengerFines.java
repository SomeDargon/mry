 ...
 * 客流罚金
 */
@ApiModel(value="客流罚金",description="客流罚金")
@Entity
@Table(name = PassengerFines.TABLE_NAME)
public class PassengerFines extends BaseEntity {

    public static final String TABLE_NAME = "passenger_fines";
