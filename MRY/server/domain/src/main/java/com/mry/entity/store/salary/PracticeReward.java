 ...
 * 实操奖励
 */
@ApiModel(value="实操奖励",description="实操奖励")
@Entity
@Table(name = PracticeReward.TABLE_NAME)
public class PracticeReward extends BaseEntity {

    public static final String TABLE_NAME = "practice_reward";
