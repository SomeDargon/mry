 ...
 * 月实操总量
 */
@ApiModel(value="月实操总量",description="月实操总量")
@Entity
@Table(name = TotalMonthlyExercise.TABLE_NAME)
public class TotalMonthlyExercise extends BaseEntity {

    public static final String TABLE_NAME = "total_monthly_exercise";
